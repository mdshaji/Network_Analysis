...
airports <- read.csv("D:/360 Digitmg - Assignments/Module 25 - Network Analytics/Network Analytics Datasets/flight_hault.csv", header = FALSE)
...
airline_routes <- read.csv("D:/360 Digitmg - Assignments/Module 25 - Network Analytics/Network Analytics Datasets/connecting_routes.csv", header=FALSE)
...
?subset
subset(centralities, (centralities[,"closenessIn"] > 0.018) & (centralities[,"betweenness"] > 0.08))
