...
airports <- read.csv("C:/Datasets_BA/Network Analytics/airports.dat", header = FALSE)
...
airline_routes <- read.csv("C:/Datasets_BA/Network Analytics/routes.dat", header=FALSE)
